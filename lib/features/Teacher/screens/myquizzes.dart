  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
            ...
            title: Text("My Quizzes",style: TextStyle(
            fontFamily: 'Judson',
          ...
          if (state is GetQuiz) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return
              container(index,context, screenHeight * .00015, screenWidth *.00009, quiz["title"],quiz["quizid"]??"",quiz["createdAt"],quiz,quizzesid);
              },
            );
    ...
    Widget container(int index,BuildContext context, double heightFactor, double widthFactor, String txt,String quizid,dynamic createdAt,dynamic quiz,List<dynamic> quizzesId) {
    final screenWidth = MediaQuery.of(context).size.width;
    final screenHeight = MediaQuery.of(context).size.height;
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                final cubit = await context.read<CreateQuizCubit>().removeQuiz(quizid);
                if (context.mounted) {
