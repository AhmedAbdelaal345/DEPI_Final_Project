...
class WrapperTeacherPage extends StatefulWidget {
  ...
  static const String id = '/wrapper-teacher-page';
  @override
  State<WrapperTeacherPage> createState() => _WrapperTeacherPageState();
}

class _WrapperTeacherPageState extends State<WrapperTeacherPage> {
  int _currentIndex = 0;
